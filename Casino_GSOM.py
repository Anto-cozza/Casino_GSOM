...
def gioca_roulette():
    ...
    with col2:
        # Area per spiegazioni sulla roulette invece dell'immagine
        st.markdown("""
        ...
        - Numero singolo: 35:1
        - Rosso/Nero, Pari/Dispari, 1-18/19-36: 1:1
        - Dozzine: 2:1
        """)
...
def gioca_blackjack():
    ...
    with col2:
        # Area per spiegazioni sul blackjack invece dell'immagine
        st.markdown("""
        ### Come funziona il Blackjack:
        - L'obiettivo è avere una mano che totalizza più punti di quella del banco, senza superare 21
        - Le carte numeriche valgono il loro valore
        - Le figure (J, Q, K) valgono 10 punti
        - L'Asso vale 11 o 1 (scegliendo il valore migliore per la mano)
        
        **Regole di base:**
        - Blackjack: un Asso e una carta da 10 punti nelle prime due carte (paga 3:2)
        - Il banco deve pescare fino ad almeno 17 punti
        - Se superi 21, perdi immediatamente (sballato)
        """)
